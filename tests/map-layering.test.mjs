...
assert.match(html, /热气球\s*\/\s*Ihlara\s*二选一[\s\S]{0,220}9\/28[^<]{0,30}周一[\s\S]{0,280}18:30共同去ASR/, 'the map-side route card should show the September 28 branch and common airport deadline');
